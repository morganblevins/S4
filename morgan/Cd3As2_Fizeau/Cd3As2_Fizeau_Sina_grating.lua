...
-- by Bo Zhao et al
-- https://journals-aps-org.libproxy.mit.edu/prb/pdf/10.1103/PhysRevB.90.220301

lat = 7
S:SetLattice({lat,0}, {0,lat})
-- S:SetLattice({lat,0}, {0,0})
S:SetNumG(5)
...
S:AddLayer('Slab', 2, 'Cd3As2')
S:AddLayer('Base', 0.4, 'Cd3As2') -- layer to copy
...
-- S:SetLayerPatternRectangle('Slab', 'Vacuum', {0,0}, 0, {0.25*lat,0})
...
for freq_eV=0.045,0.06,0.000001 do
    S:SetExcitationPlanewave(
    {theta[1], rot_ang}, -- incidence angles -- phi in [0,180), theta in [0,360)
    ...
    S:SetExcitationPlanewave(
    {theta[2], rot_ang}, -- incidence angles -- phi in [0,180), theta in [0,360)
    {0,0}, -- s-polarization amplitude and phase (in degrees)
    {1,0}) -- p-polarization amplitude and phase
    -- Define frequency
