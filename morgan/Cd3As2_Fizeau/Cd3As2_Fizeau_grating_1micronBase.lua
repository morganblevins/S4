...
for freq_eV=0.04,0.06,0.0001 do
    S:SetExcitationPlanewave(
    {theta[1],180}, -- incidence angles -- phi in [0,180), theta in [0,360)
    ...
    S:SetExcitationPlanewave(
    {theta[2], 180}, -- incidence angles -- phi in [0,180), theta in [0,360)
    {0,0}, -- s-polarization amplitude and phase (in degrees)
    {1,0}) -- p-polarization amplitude and phase
    -- Define frequency
