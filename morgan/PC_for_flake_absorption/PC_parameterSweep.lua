...
lbda_start = 0.630e-6 -- wavelength in [m]
...
local r_factor = {0.3, 0.31, 0.32, 0.33, 0.34, 0.35, 0.36, 0.37, 0.38, 0.39, 0.4}
	...
	for j=1, #r_factor do
		...
		-- for theta=0, 30, 10 do
			theta=0 do
                ...
                S:AddLayer('SiO2', 0.3, 'SiO2') -- 287 nm SiO2 layer
                S:AddLayer('SiWafer', 0, 'Silicon') -- Si wafer        
